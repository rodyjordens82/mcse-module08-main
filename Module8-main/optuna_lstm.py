...
from own_models import LSTM, Own_Models
from config import (
    USE_SAVED_DATA,
    CSV_FILE,
    ENCODED_FILE,
...
class Objective:
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        number_of_layers = trial.suggest_int("number_of_layers", 1, 5, log=True)
        ...
        # Example usage
        file_path = r'./lstm_results.txt'
        data = f'{hidden_size=}\t{learning_rate=}\t{weight_decay=}\t{batch_size=}\t{number_of_layers}\n{model.training_stats}'
        print(data)
...
if __name__ == "__main__":
    ...
    objective = Objective(
        ...
        x=x_train_tensor_unsqueezed,
        y=y_train_tensor,
        x_val=X_validate_tensor_unsqueezed,
